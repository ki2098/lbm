...
void main_loop(Cumu *cumu) {
    compute_cumulant(cumu->f, cumu->c, cumu->size);
    compute_collision(cumu->c, 1/cumu->tau, cumu->c_post, cumu->size);
    compute_post_collision_pdf(cumu->c_post, cumu->shift, cumu->f_post, cumu->size);
    compute_streaming(cumu->f_post, cumu->f, cumu->size);
    apply_bc(cumu->f, cumu->f_post, ulid, cumu->size);
}